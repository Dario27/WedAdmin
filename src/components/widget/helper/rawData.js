...
export const article = [
    {
        id: 1,
        img: '/images/samples/300x300/1.jpg',
    ...
    {
        id: 2,
        img: '/images/samples/300x300/2.jpg',
        location: 'RAGNAROCK- Museet for pop, Roskilde, Denmark',
        title: 'It’s good to start or finish the day with delicious pancakes :)',
        date: 'Published on May 23, 2018',
        count: '93'
    ...
    {
        id: 3,
        img: '/images/samples/300x300/3.jpg',
        location: 'RAGNAROCK- Museet for pop, Roskilde, Denmark',
        title: 'It’s good to start or finish the day with delicious pancakes :)',
        date: 'Published on May 23, 2018',
        count: '93'
...
export const socialData = [
    {
        ...
        subs: '2.62 Subscribers',
        text: 'Your main list growing'
    },
    {
        id: 2,
        icon: 'mdi-google text-google',
        subs: '3.4k followers',
        text: 'Your main list growing'
    },
    {
...
export const manageTickets = [
    {
        id: 1,
        userName: 'James',
        userImg: '/images/faces/face1.jpg',
        ticketId: '#23047',
        title: 'Donec rutrum congue leo eget malesuada.',
        content: 'Donec rutrum congue leo eget malesuada. Quisque velit nisi, pretium ut lacinia in, elementum id enim vivamus.',
        dueDate: '2 Days',
        response: '3 hours'
    },
    {
        id: 2,
        userName: 'Stella',
        userImg: '/images/faces/face2.jpg',
        ticketId: '#23135',
        title: 'Donec rutrum congue leo eget malesuada.',
        content: 'Donec rutrum congue leo eget malesuada. Quisque velit nisi, pretium ut lacinia in, elementum id enim vivamus.',
        dueDate: '2 Days',
    ...
    },
    {
        id: 3,
        userName: 'John Doe',
        userImg: '/images/faces/face3.jpg',
        ticketId: '#23246',
        title: 'Donec rutrum congue leo eget malesuada.',
        content: 'Donec rutrum congue leo eget malesuada. Quisque velit nisi, pretium ut lacinia in, elementum id enim vivamus.',
        dueDate: '2 Days',

    ...
    <>
        <div className="col-md-7">
            ...
            <div className="template-demo d-flex justify-content-between flex-nowrap">
              <Button variant="btn btn-primary btn-rounded btn-icon">
                <i className="mdi mdi-home-outline"></i>
              </Button>
              <Button variant="btn btn-dark btn-rounded btn-icon">
                <i className="mdi mdi mdi-microsoft-internet-explorer"></i>
              </Button>
              <Button variant="btn btn-danger btn-rounded btn-icon">
                <i className="mdi mdi-email-open"></i>
              </Button>
              <Button variant="btn btn-info btn-rounded btn-icon">
                <i className="mdi mdi-star"></i>
              </Button>
              <Button variant="btn btn-success btn-rounded btn-icon">

    ...
    <>
        <div className="col-md-5">
            ...
            <div className="template-demo mt-4">
              <Button variant="btn btn-danger btn-lg">btn-lg</Button>
              <Button variant="btn btn-success btn-md">btn-md</Button>
              <Button variant="btn btn-primary btn-sm">btn-sm</Button>
            </div>
        </div>
    </>
  )

...
function BasicFormElements() {
  return (
    ...
    <Form.Group>
      ...
      <Form.Select aria-label='Example select' className='form-select' id='exampleSelectGender'>
        <option>Male</option>
    ...
    <Button type='submit' variant='btn btn-primary' className='me-2'>Submit</Button>

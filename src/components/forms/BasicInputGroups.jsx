  ...
  return (
    ...
    <InputGroup>
        {/* <div className='input-group'> */}
            <div className='input-group-prepend'>
                ...
                <InputGroup.Text className='bg-primary text-dark'>$</InputGroup.Text>
            </div>
    ...
    <InputGroup>
        {/* <div className="input-group"> */}
            ...
            <div className="input-group-append">
                <Button variant="btn btn-primary" size="sm">Search</Button>
            </div>
        {/* </div> */}
    </InputGroup>
    <InputGroup>
        {/* <div className='input-group'> */}
            <div className='input-group-prepend'>   
                <DropdownButton variant='btn btn-outline-primary' title="Dropdown" className='dropdown-toggle' size='sm'>
                    ...
                    <Dropdown.Item className='dropdown-item' href='!#' onClick={event => event.preventDefault()}>Separated link</Dropdown.Item>
                </DropdownButton>
            </div>

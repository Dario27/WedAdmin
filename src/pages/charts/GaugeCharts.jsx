                ...
                <div className="col-md-6 grid-margin">
                    <div className="card">
                        <div className="card-body">
                            ...
                            <GaugeChart id="gauge-chart1" textColor="#fffff" />
                        </div>
                    </div>
                </div>
                <div className="col-md-6 grid-margin">
                    <div className="card">
                        ...
                        <h4 className="card-title">With 20 levels and pointer at 86%</h4>
                            <GaugeChart id="gauge-chart2" nrOfLevels={20} percent={0.86} textColor="#fffff" />
                        </div>
                    </div>
                </div>
                <div className="col-md-6 grid-margin">
                    <div className="card">
                        ...
                        <h4 className="card-title">Custom colors and larger arc width</h4>
                            <GaugeChart id="gauge-chart3" nrOfLevels={30} colors={["#FF5F6D", "#FFC371"]} arcWidth={0.3} percent={0.37} textColor="#fffff" />
                        </div>
                    </div>
                </div>
                <div className="col-md-6 grid-margin">
                    <div className="card">
                        ...
                        <h4 className="card-title">Custom corner radius and larger padding</h4>
                            <GaugeChart id="gauge-chart4" nrOfLevels={10} arcPadding={0.1} cornerRadius={3} percent={0.6} textColor="#fffff" />
                        </div>
                    </div>
                </div>
            </div>

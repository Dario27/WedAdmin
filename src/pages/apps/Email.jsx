          ...
          <div className="mail-sidebar d-none d-lg-block col-xl-2 pt-3 bg-dark">
            <div className="menu-bar">
              <ul className="menu-items">
                ...
                <li className="active"><a href="!#" onClick={evt =>evt.preventDefault()}><i className="mdi mdi-email-outline"></i> Inbox</a><span className="badge badge-pill bg-success">8</span></li>
                <li><a href="!#" onClick={evt =>evt.preventDefault()}><i className="mdi mdi-share"></i> Sent</a></li>
                <li><a href="!#" onClick={evt =>evt.preventDefault()}><i className="mdi mdi-file-outline"></i> Draft</a><span className="badge badge-pill bg-warning">4</span></li>
                <li><a href="!#" onClick={evt =>evt.preventDefault()}><i className="mdi mdi-upload"></i> Outbox</a><span className="badge badge-pill bg-danger">3</span></li>
          ...
          <div className="mail-view d-none d-md-block col-xl-7 bg-dark">
            ...
            <div className="message-body">
              ...
              <div className="attachments-sections">
                <ul>
                  <li>
                    <div className="thumb"><i className="mdi mdi-file-pdf-box text-warning"></i></div>
                    <div className="details">
                  ...
                  <li>
                    <div className="thumb"><i className="mdi mdi-file-image text-warning"></i></div>
                    <div className="details">

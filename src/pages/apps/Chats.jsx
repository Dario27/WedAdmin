            ...
            <div className="row mx-0">
              <div className={`col-xl-3 col-md-4 chat-list-wrapper px-0`}>
                ...
                <div className="sidebar-spacer d-grid gap-2">
                  <button className="btn btn-success py-3" type="button">+ New Chat</button>
                </div>
              </div>
              ...
              <div className="col-xl-3 d-none d-lg-block px-0 chat-sidebar">
                ...
                <div className="px-4">
                  <div className="d-flex pt-4">
                    ...
                    <div className="badge bg-success mb-auto ms-auto">Online</div>
                  </div>
                  <div className="pt-3">
                  ...
                  <div className="list-item">
                    <div className="d-flex align-items-center justify-content-center img-sm bg-success">
                  ...
                  <div className="list-item">
                    <div className="d-flex align-items-center justify-content-center img-sm bg-danger">
                      <i className="mdi mdi-cash-multiple icon-sm"></i></div>
                    <div className="wrapper ps-3">
                      <h5 className="fw-medium mb-0">$2300</h5>
                      <p className="text-muted mb-0">Deposit</p>
                  ...
                  <div className="list-item border-bottom-0">
                    <div className="d-flex align-items-center justify-content-center img-sm bg-info">
                      <i className="mdi mdi-cash-multiple icon-sm"></i></div>
                  ...
                  <div className="list-item">
                    <div className="d-flex align-items-center justify-content-center img-sm bg-primary">

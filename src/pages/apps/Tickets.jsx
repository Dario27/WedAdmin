            ...
            <div className="card-body">
              <div className="d-sm-flex pb-4 mb-4 border-bottom">
                ...
                <form className='ms-lg-auto d-flex pt-2 pt-md-0 align-items-center justify-content-end'>
                  ...
                  <Button type="submit" variant="btn btn-success no-wrap ms-lg-4 ms-0 px-2 px-lg-4 mb-1" style={{height:'2.75rem'}}>Search Tickets</Button>
                </form>
              </div>
                            ...
                            <a href="!#" className="tickets-card row mx-0" onClick={evt =>evt.preventDefault()}>
                              <div className="tickets-details col-lg-7 col-12">
                                <div className="wrapper">
                                  ...
                                  <div className="badge bg-info">Pro</div>
                                </div>

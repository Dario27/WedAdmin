            ...
            <div className="card-body p-3">
              <div className="d-flex flex-column flex-md-row align-items-center flex-wrap">
                ...
                <div className="wrapper d-none d-lg-flex  align-items-center my-2">
                  ...
                  <Button type="button" variant="btn private-btn btn-fw ms-4 text-black"><i className="mdi mdi-lock me-1"></i>Private</Button>
                </div>
                <div className="wrapper ms-md-auto  d-none d-lg-flex flex-column flex-md-row kanban-toolbar ms-md-0 my-2">
                  <div className="d-flex">
                    <Button type="button" variant="btn btn-icons btn-light d-none d-lg-block">
                      <i className="mdi mdi-magnify"></i>
                    </Button>
                    <Button type="button" variant="btn btn-icons btn-light d-none d-lg-block">
                      <i className="mdi mdi-filter-outline"></i>
                    </Button>
                    <Button type="button" variant="btn btn-icons btn-light">
                      <i className="mdi mdi-bell-outline"></i>
                    </Button>
                    <Button type="button" variant="btn btn-primary">Boards</Button>
                  </div>
                  <div className="d-flex mt-4 mt-md-0">
                    <Button type="button" variant="btn btn-success">Create New</Button>
                  </div>
                </div>
              </div>
              <div className="row">

...
import { growthOverview, manageTickets, socialData } from '../../components/widget/helper/rawData'
import ProductAnalysis from '../../components/charts/chartjs/dashboard/ProductAnalysis'
import Todo from '../../components/apps/TodoApp'
import Profit from '../../components/charts/chartjs/dashboard/Profit'
          ...
          <div className="col-12">
            <div className="page-header">
              ...
              <div className="quick-link-wrapper w-100 d-md-flex flex-md-wrap">
                ...
                <ul className="quick-links me-auto">
                ...
                <div className="row">
                  <div className="col-xl-3 col-lg-6 col-sm-6 grid-margin-xl-0 grid-margin">
                    <div className="d-flex">
                      ...
                      <div className="wrapper my-auto me-auto ms-lg-4">
                        <VisitsMini />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="card-body">
                      ...
                      <div className="col-xl-5 col-lg-12">
                        <div className="wrapper border-bottom mb-2 pb-2">
                          ...
                          <div className="d-flex align-items-center">
                            ...
                            <div className="dot-indicator bg-secondary me-auto"></div>
                          </div>
                        </div>
                        <div className="wrapper mb-2 mb-lg-0">
                          ...
                          <div className="d-flex align-items-center">
                            ...
                            <div className="dot-indicator bg-primary me-auto"></div>
                          </div>
                        </div>
                      </div>
                      <div className="col-xl-7 col-lg-12 d-flex ps-4">
                        <div className="me-auto charty">
                    ...
                    <div className="row mt-5">
                      ...
                      <div className="col-xl-7 col-lg-12">
                        <div className="mt-n3 me-auto" id="dashboard-guage-chart"></div>
                  ...
                  <div className="card-body">
                    ...
                    <div className="wrapper">
                      <div className="d-flex w-100 pt-2 mt-4">
                        ...
                        <div className="wrapper me-auto d-flex align-items-center">
              ...
              <div className="col-md-12 grid-margin">
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="d-flex gap-3 mt-3 py-2 border-bottom">
                      ...
                      <small className="text-muted me-auto">1 Hours ago</small>
                    </div>
                    <div className="d-flex gap-3 py-2 border-bottom">
                      ...
                      <small className="text-muted me-auto">4 Hours ago</small>
                    </div>
                    <div className="d-flex gap-3 py-2 border-bottom">
                    ...
                    <div className="d-flex gap-3 pt-2">
                      ...
                      <small className="text-muted me-auto">7 Hours ago</small>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="card">
              <div className="card-body">
                ...
                <div className="d-flex py-2 border-bottom">
                  ...
                  <small className="text-muted me-auto">Edit event</small>
                </div>
                <div className="d-flex py-2 border-bottom">
                  <div className="wrapper">
                    <small className="text-muted">Mar 14, 2019</small>

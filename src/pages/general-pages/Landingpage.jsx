        ...
        <div className="container">
          ...
          <div className="row mb-5">
            <div className="col-md-4 grid-margin">
              <div className="m-3">
                <div className="card card-item-preview">
                  <img className="card-img-top" src= "/images/samples/dashboard.png" alt="sample" />
                  <div className="card-body py-3 border-top">
                    <label className="badge bg-warning">New</label>
            ...
            <div className="col-md-4 grid-margin">
              <div className="m-3">
                <div className="card card-item-preview">
                  <img className="card-img-top" src= "/images/samples/widgets.png" alt="sapmle" />
                  <div className="card-body py-3 border-top">
            ...
            <div className="col-md-4 grid-margin">
              <div className="m-3">
                <div className="card card-item-preview">
                  <img className="card-img-top" src= "/images/samples/modal.png" alt="demo" />
                  <div className="card-body py-3 border-top">
            ...
            <div className="col-md-4 grid-margin">
              <div className="m-3">
                <div className="card card-item-preview">
                  <img className="card-img-top" src= "/images/samples/e-commerce.png" alt="demo" />
                  <div className="card-body py-3 border-top">
            ...
            <div className="col-md-4 grid-margin">
              <div className="m-3">
                <div className="card card-item-preview">
                  <img className="card-img-top" src= "/images/samples/email.png" alt="demo" />
                  <div className="card-body py-3 border-top">
            ...
            <div className="col-md-4 grid-margin">
              <div className="m-3">
                <div className="card card-item-preview">
                  <img className="card-img-top" src= "/images/samples/charts.png" alt="demo" />
                  <div className="card-body py-3 border-top">
                    <label className="badge bg-success">New</label>
            ...
            <div className="col-md-4 grid-margin">
              <div className="m-3">
                <div className="card card-item-preview">
                  <img className="card-img-top" src= "/images/samples/editors.png" alt="demo" />
                  <div className="card-body py-3 border-top">
            ...
            <div className="col-md-4 grid-margin">
              <div className="m-3">
                <div className="card card-item-preview">
                  <img className="card-img-top" src= "/images/samples/forms.png" alt="demo" />
                  <div className="card-body py-3 border-top">
                    <label className="badge bg-info">New</label>
            ...
            <div className="col-md-4 grid-margin">
              <div className="m-3">
                <div className="card card-item-preview">
                  <img className="card-img-top" src= "/images/samples/popup.png" alt="demo" />
                  <div className="card-body py-3 border-top">

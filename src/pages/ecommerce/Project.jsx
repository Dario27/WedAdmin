                ...
                <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid" key={id}>
                  ...
                  <div className="project-grid-inner">
                    ...
                    <div className="d-flex align-items-start">
                      ...
                      <div className={data.status == 'Finished' ? 'badge bg-success ms-auto' : data.status == 'On going' ? 'badge bg-warning ms-auto' : data.status == 'Hold' ? 'badge bg-danger ms-auto' : null}>{data.status}</div>
                    </div>

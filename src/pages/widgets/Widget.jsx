              ...
              <div className="card-body">
                <div className="clearfix">
                  ...
                  <div className="float-end">
                    <p className="mb-0 text-end text-light">{data.title}</p>
                    <div className="fluid-container">
                      <h3 className="fw-medium text-end mb-0 text-light">{data.count}</h3>
                    </div>
                  </div>
                </div>
            ...
            <div className="card card-statistics">
              <div className="card-body pb-0">
                ...
                <div className="d-flex align-items-center">
                  ...
                  <h6 className={`fw-semibold ms-2 ${data.amountChange.includes("-") ? 'text-danger' : 'text-success'}`}>{data.amountChange}</h6>
                </div>
              ...
              <div key={id} className="card-col col-xl-3 col-lg-3 col-md-3 col-6">
                <div className="card-body">
                  <div className="d-flex align-items-center justify-content-center flex-column flex-sm-row">
                    <i className={data.icon}></i>
                    <div className="wrapper text-center text-sm-start">
            ...
            <div className="card">
              <div className="card-body">
                ...
                <div key={id} className="wrapper d-flex align-items-center py-2 border-bottom">
                  ...
                  <div className="badge badge-pill bg-success ms-auto px-1 py-1">
                    <i className={data.icon}></i>
                  </div>
                </div>
                ))}

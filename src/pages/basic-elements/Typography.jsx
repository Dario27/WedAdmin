          ...
          <div className="card">
            ...
            <div className="card-body">
              <blockquote className="blockquote blockquote-primary">
                ...
                <div className="blockquote-footer text-muted">Someone famous in <cite title="Source Title">Source Title</cite></div>
              </blockquote>
            </div>
          </div>
        </div>
            ...
            <div className="card-body">
              ...
              <div className="media">
                ...
                <div className="media-body">
                  <p className="card-text">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque.</p>
                </div>
              </div>
            </div>
          </div>

      ...
      <div className="d-flex align-items-center auth px-0">
        <div className="row w-100 mx-0">
          <div className="col-lg-4 mx-auto">
            <div className="auth-form-transparent text-start py-5 px-4 px-sm-5">
              ...
              <Form className="pt-3">
                ...
                <div className="text-center mt-4 fw-light">
                  Don't have an account? <Link to="/user-pages/register" reloadDocument className="text-primary">Create</Link>
                </div>
              </Form>
            </div>
          </div>

          ...
          <div className="card px-3">
            ...
            <h4 className="card-title">Toast Styles</h4>
              ...
              <div className="template-demo d-flex justify-content-md-between flex-wrap">
                <Button variant="btn btn-success btn-fw" onClick={() => toast.success("This is success message!")}>Success</Button>
                <Button variant="btn btn-info btn-fw" onClick={() => toast.info("This is info message!")}>Info</Button>
                <Button variant="btn btn-warning btn-fw" onClick={() => toast.warning("This is warning message!")}>Warning</Button>
                <Button variant="btn btn-danger btn-fw" onClick={() => toast.error("This is error message!")}>Error</Button>
                <ToastContainer />
              </div>
            </div>
          </div>
